...
import { Pencil, X, Check, Landmark, TrendingUp, Receipt, ShoppingCart, CreditCard, PiggyBank, Zap, Sparkles, UtensilsCrossed, Wallet, Tv, TrendingDown } from "lucide-react";
...
>
  ...
  {/* Lista em formato de "Steppers" horizontais ou verticais limpos */}
  ...
  <Button
  onClick={() => {
    // Certifique-se de que a seção de gastos abaixo tenha id="transactions-section"
    const section = document.getElementById("transactions-section");
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
    } else {
      console.warn("Seção 'transactions-section' não encontrada.");
    }
  }}
