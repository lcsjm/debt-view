    ...
    <div className="flex flex-col sm:flex-row items-center gap-4">
      ...
      <div className="flex gap-3">
        ...
        <a 
          ...
          className="flex items-center gap-2 bg-white/10 hover:bg-[#C1188B] text-white px-4 py-2 rounded-lg border border-white/20 transition-all duration-300 group shadow-sm"
        >
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center gap-2 bg-white/10 hover:bg-[#E80070] text-white px-4 py-2 rounded-lg border border-white/20 transition-all duration-300 group shadow-sm"
        >
          <Apple size={16} />
          <div className="flex flex-col items-start leading-tight">
            <span className="text-[10px] opacity-70">Baixar na</span>
