...
export default function Simulators() {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 w-full relative z-10">
              <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-[#E80070]/10 text-[#E80070] dark:bg-[#E80070]/20 dark:text-[#FF85BB]">
              ...
              <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">
              ...
              <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-[#426DA9]/10 text-[#426DA9] dark:bg-[#426DA9]/20 dark:text-[#8CB4F5]">
              ...
              <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
 ...
 text-slate-600 dark:text-slate-400 uppercase tracking-widest mb-2 block">
                  Valor Original *
                </label>
 ...
 clearAnalysis();
              ...
              <div className="lg:col-span-3">
                ...
                <div 
 className={currencyWrapperClass}>
                  <span className="pl-4 text-slate-500 text-sm font-medium select-none pointer-events-none">R$</span>
                  <Controller
                    name="downPayment"
                    control={control}
   ...
   axisLine={false}
    ...
    <Area 
            ...
            strokeWidth={4} 
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-[#1D4F91]/5 dark:bg-[#1D4F91]/10 p-5 rounded-2xl mb-6 border 
 border-[#1D4F91]/10">
 ...
 'justify-end' : ''}`}>
              {!editingId && (
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-[#426DA9]/10 text-[#426DA9] dark:bg-[#426DA9]/20 dark:text-[#8CB4F5] px-6 py-4 rounded-xl 
 font-bold hover:bg-[#426DA9]/20 dark:hover:bg-[#426DA9]/30 transition-all"
                >
      ...
      <motion.button
            ...
            disabled={isSaving}
                  ...
                  className={`flex items-center justify-center gap-2 bg-gradient-to-r from-[#E80070] to-[#C1188B] text-white rounded-xl font-bold shadow-lg shadow-[#E80070]/20 hover:shadow-xl hover:shadow-[#E80070]/30 transition-all disabled:opacity-70 ${
                    editingId ?
 "px-6 py-2.5 text-sm w-full sm:w-auto" : "flex-1 px-6 py-4"
                  }`}
                >
                  {isSaving ?
 <RefreshCw className="w-5 h-5 animate-spin" /> : <Plus className="w-5 h-5" />}
                  {editingId ?
 "Atualizar Parcelamento" : "Registrar Parcelamento"}
                </motion.button>
              )}
            </div>
          </form>
 ...
 return `${m.charAt(0).toUpperCase() + m.slice(1)}/${dObj.getFullYear()}`;
                  ...
                  const valorParcela = installmentsCount > 0 ?
 totalComJuros / installmentsCount : 0;
 ...
 tracking-wider px-2.5 py-1 rounded-md ${getStatusStyle(
                                d.status,
                              )}`}
                            >
 ...
 0) > 0 && (
   ...
   Início: {startMY} • Término: {endMY}
                            ...
                            {valorParcela > 0 && (
                              <span className="text-sm font-bold text-[#426DA9] 
 dark:text-[#8CB4F5] mt-1">
                      ...
                      <div className="flex justify-between items-end border-t border-slate-100 dark:border-slate-800 mt-2 
 pt-4 pl-2">
                        <div>
         ...
         Entrada: <strong className="text-[#C1188B]">
